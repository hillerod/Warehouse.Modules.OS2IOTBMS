...
namespace Module.AppFunctions
{
    public class ApiBaseConfigurationOptions : IOpenApiConfigurationOptions
    {
        ...
        {
            Version = "1.0.0",
            Title = "OpenAPI for communication between OS2IOT and BMS",
            Description = "",
            ...
            Contact = new OpenApiContact()
            {
                ...
                Url = new Uri("https://github.com/hillerod/Warehouse.Modules.OS2IOTBMS"),
            },
            License = new OpenApiLicense()
            {
                Name = "MIT",
                Url = new Uri("https://github.com/hillerod/Warehouse.Modules.OS2IOTBMS/blob/master/License.md"),
            }
        };
